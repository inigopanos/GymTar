...
if __name__ == "__main__":
    ...
    fusion_configurations = sl.read_fusion_configuration_file(ruta, sl.COORDINATE_SYSTEM.RIGHT_HANDED_Y_UP, sl.UNIT.METER)
    ...
    while viewer.is_available():
        ...
        if fusion.process() == sl.FUSION_ERROR_CODE.SUCCESS:
            ...
            # viewer.update_bodies(bodies) # Comentado porque si no da error de que GL.Viewer no tiene update_bodies. ¿Igual tiene que ser cv_viewer?
